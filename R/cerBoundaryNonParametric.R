...
getPCER2 <- function(p1, ss1, ss2, cJ2, wJh) {
  if (ss1 == 0 || ss2 == 0) stop("Error: ss1 or ss2 is zero | function:getPCER")
  # local Seed##
  set.seed(200295)
  #################################
...
exitProbStage2Nparam <- function(aj2, aj1, ss1, ss2) # aj2: stage 2 bdry, aj1: stage-1 boundary
{
  # Set local seed##
  set.seed(200295)
  #################################
...
exitProbStage2Nparam2 <- function(cJ2, cJ1, ss1, ss2, wJ, hIDX) # aj2: stage 2 bdry, aj1: stage-1 boundary
{
  aj2 = cJ2 * wJ[hIDX]
  aj1 = cJ1 * wJ[hIDX]
  # Set local seed##
