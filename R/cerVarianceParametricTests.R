                           ...
                           Stage2AllocSampleSize,Stage2allocRatio,Stage2sigma)
{
  ...
  for (i in 1:length(Stage2sigma))
  {
    ...
    Stage2InfoMat[[names(Sigma$SigmaZ)[i]]] <- Stage2InfoMatrixCum
    ...
    Stage2SigmaS[[names(Sigma$SigmaS)[i]]] <- Stage2sigmaS
  }
