...
PlanBdry <- lapply(w, function(x)
  {
  des<- rpact::getDesignGroupSequential(kMax = 2, alpha = x*alpha, 
...
getStage2BdryAdj <- function(a1,p1,v,BJ,info_frac)
{
  ...
  getAdjPCER <- function(g,a1,p1, v,info_frac)
  {
    ...
    a2adj <- unlist(lapply(1:length(e),
                           function(x){getStage2Bdry(ej = e[x], aj1 = a1[x],
                                                     info_frac = info_frac)}
    ))
...
Stage2BdryAdj <- getStage2BdryAdj(a1=PlanBdryDF$Stage1PlanBdry,
