...
test_that('Test computations of Adjusted P-values',{
  ...
  test.type <- 'Dunnett'
  p <- matrix(c(0.252463317,0.238189947,0.071954653,0.00361405,
  ...
  h <- matrix(c(1,1,1,1,  0.5,0.5,0,0,
  ...
  nrow = 8, byrow = T)
  cr <- matrix(c(1,0.5,NA,NA,
                 0.5,1,NA,NA,
                 NA,NA,1,0.5,
                 NA,NA,0.5,1), nrow = 4, byrow = T)
  ...
  nrow = 8, byrow = T)
  cr <- matrix(c(1,NA,NA,NA,
                 NA,1,NA,NA,
                 NA,NA,1,NA,
                 NA,NA,NA,1), nrow = 4, byrow = T)
