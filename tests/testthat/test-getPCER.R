...
test_that("Test PCER computations", {
  ...
  # out <- getPCER(a2 = a2, p1 = p1, ss1 = ss1, ss2 = ss2, t1 = ss1/(ss1+ss2))
  ...
  out <- sapply(p1, function(x){
    getPCER(a2 = a2, p1 = x, ss1 = ss1, ss2 = ss2, t1 = ss1/(ss1+ss2))
  })
  expect_equal(object = out, expected = benchmark)

  # Test Case4: expect error if ss1 = 0 or ss2 = 0
  expect_error(getPCER(a2 = 0.0244, p1 = 0.03963089, ss1 = 0, ss2 = 100, t1 = 0))
  expect_error(getPCER(a2 = 0.0244, p1 = 0.03963089, ss1 = 50, ss2 = 0, t1 = 1))
})
