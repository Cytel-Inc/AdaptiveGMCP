...
test_that('Test Plan Parametric Boundary(CER Method)',{
  ...
  allocRatio <- c(1,1,1)
  SS_Cum <- matrix(c(50,50,50,
                     100,100,100), nrow = 2, byrow = T)

  Sigma <- getSigma(SS_Cum, sigma, allocRatio)
  gIDX <- 1
  hIDX <- c(1,2)
  typeOfDesign <- 'asOF'
  Scale <- 'Score'
  ...
  benchmark <- matrix(c(0.00078229234168911, 0.00078229234168911,
                        0.0131202663476177, 0.0131202663476177), nrow = 2, byrow = T)
  ...
  allocRatio <- c(1,2,1)
  SS_Cum <- matrix(c(50,100,50,
                     100,200,100), nrow = 2, byrow = T)
  ...
  #Benchmarks From East
  benchmark <- matrix(c(0.00141441817289648, 0.000126137793428335,
                        0.0199601761219444 , 0.00589281584231451), nrow = 2, byrow = T)
  ...
  expect_equal(object = all(pBdryEP1 == pBdryEP2) & all(pBdryEP1 == pBdryEP3),
               expected = TRUE)
  ...
  #Benchmarks From East
  benchmark <- matrix(c(0,                  0,
                        0.0134479578529462, 0.0134479578529462), nrow = 2, byrow = T)
