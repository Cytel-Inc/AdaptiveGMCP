...
output:
  ...
  html_document:
    ...
    toc: yes
    toc_depth: 4
vignette: "%\\VignetteIndexEntry{Normal Binary Simulations} %\\VignetteEngine{knitr::rmarkdown}
...
<!-- -->
```
-   With the common standard deviation option selected in the simulation function the the treatment arms standard deviations will be same as the control arm.
